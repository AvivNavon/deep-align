            ...
            for j in range(self.n_layers):
                ...
                if i == j:
                    ...
                    self.layers[f"{i}_{j}"] = NonNeighborInternalLayer(
                        ...
                        reduction=reduction,
                        bias=bias,
                        first_dim_is_input=(i == 0) and hnp_setup,
                        first_dim_is_output=(i == self.n_layers - 1) and hnp_setup,
                        last_dim_is_output=(j == self.n_layers - 1) and hnp_setup,
                    )
